...
curl -s -k https://raw.githubusercontent.com/camilojtorresc/MyMCProduction/refs/heads/main/Early2022/myXibTomumuXi/$step0_fragmentfile
...
cmsDriver.py  --python_filename $step1_configfile --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring \
              --datatier GEN-SIM-RAW --fileout file:$step1_resultfile --pileup_input "filelist:chain_124X_mcRun3_2022_realistic_postEE_v1_MiniAOD.txt" \
