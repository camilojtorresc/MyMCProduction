...
#cmsdriver origin: https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_test/BPH-Run3Summer22EEDRPremix-00130
cmsDriver.py  --DIGIpython_filename $step2_configfile --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring \
          --datatier AODSIM --fileout file:$step2_resultfile \
          --conditions 124X_mcRun3_2022_realistic_postEE_v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM --procModifiers siPixelQualityRawToDigi \
          --geometry DB:Extended --filein file:$step1_resultfile --era Run3 --no_exec --mc -n -1
...
cmsDriver.py  --python_filename $step3_configfile --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring \
          --datatier MINIAODSIM --fileout file:$step3_resultfile \
          --conditions 124X_mcRun3_2022_realistic_postEE_v1 --step PAT \
          --geometry DB:Extended --filein file:$step2_resultfile --era Run3 --no_exec --mc -n -1
